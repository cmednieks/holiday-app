...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { edit: @holiday.edit, index: @holiday.index, new: @holiday.new, show: @holiday.show }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { edit: @holiday.edit, index: @holiday.index, new: @holiday.new, show: @holiday.show }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
